...
[![Build Status](https://travis-ci.org/Slayer95/Pokemon-Showdown-Plugin-Base.svg)](https://travis-ci.org/Slayer95/Pokemon-Showdown-Plugin-Base)
[![Dependency Status](https://david-dm.org/Slayer95/Pokemon-Showdown-Plugin-Base.svg)](https://david-dm.org/Slayer95/Pokemon-Showdown-Plugin-Base)
[![devDependency Status](https://david-dm.org/Slayer95/Pokemon-Showdown-Plugin-Base/dev-status.svg)](https://david-dm.org/Slayer95/Pokemon-Showdown-Plugin-Base#info=devDependencies)

Introduction
------------------------------------------------------------------------

This is a fork for the game server of [Pokémon Showdown][4], a website for Pokémon battling. Pokémon Showdown simulates singles, doubles and triples battles in all the games out so far (Generations 1 through 6).

This repository contains the files needed to set up your own modded Pokémon Showdown server. Note that to set up a server, you'll also need a server computer.
